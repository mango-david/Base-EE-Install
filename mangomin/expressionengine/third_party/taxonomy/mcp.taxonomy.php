...
class Taxonomy_mcp {
	...
	public function __construct()
	{
		...
		$this->_theme_base_url 	= defined('URL_THIRD_THEMES') ? URL_THIRD_THEMES . 'taxonomy_assets/' : $this->EE->config->item('theme_folder_url') . '/third_party/taxonomy_assets/';
	...
	public function index()
	{
		...
		$this->EE->view->cp_page_title = lang('taxonomy_module_name');
