...
switch ( $_SERVER['SERVER_ADDR'] ) {
	...
	$db['expressionengine']['username'] = "davidlei_redgum";
	$db['expressionengine']['password'] = "alpaca2610*";
	$db['expressionengine']['database'] = "davidlei_redgum";
    break;

  // local (using remote database)
    case '::1' :
	$db['expressionengine']['hostname'] = "202.40.166.120::80";
	$db['expressionengine']['username'] = "davidlei_redgum";
	$db['expressionengine']['password'] = "alpaca2610*";
	$db['expressionengine']['database'] = "davidlei_redgum";
    break;
/*    
    ...
    case '127.0.0.1' :
	$db['expressionengine']['hostname'] = "localhost";
	$db['expressionengine']['username'] = "davidlei_testing";
	$db['expressionengine']['password'] = "Monitor44";
	$db['expressionengine']['database'] = "davidlei_testing";
    break;
*/    
}
...
-------------------------------------------------------------------*/
$config['avatar_url'] = $config['site_url']."/uploads/avatars/";
$config['avatar_path'] = $config['server_path']."/uploads/avatars/";
$config['photo_url'] = $config['site_url']."/uploads/member_photos/";
$config['photo_path'] = $config['server_path']."/uploads/member_photos/";
$config['sig_img_url'] = $config['site_url']."/uploads/signature_attachments/";
$config['sig_img_path'] = $config['server_path']."/uploads/signature_attachments/";
$config['prv_msg_upload_path'] = $config['server_path']."/uploads/pm_attachments/";
...
$config['tmpl_file_basepath'] = $config['server_path']."/structure/";
...
$config['low_variables_file_path'] = $config['server_path']."/structure/low_variables";
